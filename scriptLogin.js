...
document.querySelector('.back__btn').addEventListener('click',function(e){
    e.preventDefault();
...
// const new_account=document.querySelector('.btn__confirm');
// const create_name=document.querySelector('.create__first__name');
// const create__last__name=document.querySelector('.create__last__name');
// const create__pin=document.querySelector('.create__pin');

// new_account.addEventListener('click',function(e){
//     e.preventDefault();
//     let temp={};
//     temp.owner=`${create_name.value} ${create__last__name.value}`;
//     temp.movements=[];
//     temp.pin=create__pin.value;
//     console.log(temp);

// })

console.log("HI Moin bhai ")
